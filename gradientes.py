...
def funcion():
	img = cv2.imread("/home/juan/Descargas/foto.jpg") 
	...
	plt.subplot(222),plt.imshow(opened,cmap = 'gray')
	plt.title('Binary Image'), plt.xticks([]), plt.yticks([])
	plt.subplot(223),plt.imshow(masked)
	plt.title('Resultant Image'), plt.xticks([]), plt.yticks([])
	plt.subplot(224),plt.imshow(image_copy)
