#ifndef INTERFAZ_TURTLEBOT_H
#define INTERFAZ_TURTLEBOT_H
...
// rviz::Panel.
class InterfazTurtlebot: public rviz::Panel
{
...
public:
	...
	InterfazTurtlebot(QWidget* parent = 0);
